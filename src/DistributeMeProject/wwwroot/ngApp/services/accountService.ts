namespace DistributeMeProject.Services {
    ...
    export class AccountService {
        ...
        public hasDistributor(distributor) {
        ...
        public register(userLogin) {
            ...
            return this.$q((resolve, reject) => {
                if (userLogin.business === "restaurant") {
                    this.$http.post('/api/account/registerrestaurant', userLogin)
                        .then((result) => {
                            this.storeUserInfo(result.data);
                            resolve(result);
                        })
                ...
                else if (userLogin.business === "distributor") {
                    this.$http.post('/api/account/registerdistributor', userLogin)
                        .then((result) => {
                            this.storeUserInfo(result.data);
                            resolve(result);
                        })
    ...
    angular.module('DistributeMeProject').service('accountService', AccountService);
}
